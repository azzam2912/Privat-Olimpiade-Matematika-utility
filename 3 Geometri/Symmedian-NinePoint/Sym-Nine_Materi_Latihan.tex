...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{symmedian.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.4]{config_symmedian.png}
...
Secara matematis, sebuah homothety $h$ adalah transformasi yang didefinisikan oleh titik pusat, sebutlah $O$, dan sebuah faktor skala bilangan real $k$. Homothety ini mengirim titik $P$ ke titik $h(P)$, dengan mengalikan jarak dari $O$ sebanyak $k$.
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[scale=0.7]{homothety-negatif.png}
        \caption{Homothety dengan pusat $O$ dan $k$ negatif}
        \label{fig:homothety-negatif}
    \end{figure}
    \begin{figure}[h]
        \centering
        \includegraphics[scale=0.7]{homothety-positif.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{nine-point-circle.png}
...
\begin{enumerate}[resume]
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[scale=0.4]{euler-line.png}
        \caption{Euler Line}
