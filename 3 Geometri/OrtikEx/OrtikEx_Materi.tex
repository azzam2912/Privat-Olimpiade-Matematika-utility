...
\item Seperti pada contoh gambar di atas, buktikan bahwa $AH=2OM$.

\item Seperti pada contoh gambar di atas, buktikan bahwa $T$ berada di lingkaran luar $\triangle ABC$.

\item Buktikan bahwa pencerminan $H$ terhadap $BC$ juga berada di lingkaran luar $\triangle ABC$.
 ...
 \item Diberikan segitiga lancip $ABC$. Titik $H$ adalah pertemuan garis-garis tinggi $\triangle ABC$. Titik $M$ adalah titik tengah  $BC$. Misalkan titik $N$ pada $AM$. Buktikan bahwa $HN \perp AM$ jika dan hanya jika $B,H,N,C$ konsiklis.

 \item Diberikan segitiga lancip $ABC$ dengan $AB>AC$. $BE$ dan $CF$ adalah garis tinggi $\triangle ABC$. Perpanjangan $EF$ memotong $BC$ di $P$. Jika $H$ adalah titik tinggi $\triangle ABC$ dan $D$ titik tengah $BC$, buktikan bahwa $PH \perp AD$.
...
\section{Ex}
Chapter ini sebagian besar diambil dari Chapter 1 Evan Chen's EGMO (Euclidean Geometry on Mathematical Olympiad). Sangat direkomendasikan agar mempelajarinya dengan baik di buku tersebut :).
\begin{lemma}
