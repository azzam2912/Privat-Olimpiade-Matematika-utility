...
\begin{enumerate}[resume]
    ...
    \item Defined that the symbol $\triangle$ as an operation satisfies the following conditions:
    \begin{enumerate}[(i)]
    ...
    \item If $p \oplus q = p + 2 \times p + 3 \times q - 4 \times q + 5 \times p$, find the value of $3 \oplus 7$.
