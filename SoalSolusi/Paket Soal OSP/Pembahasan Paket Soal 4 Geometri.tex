...
Jawablah soal-soal berikut dengan jawaban akhir tanpa menyertakan cara.
	...
	\begin{soalbaru}
		...
		\end{jawaban}
		\begin{solusi}
		Dikarenakan $DB = DE$, maka $\angle DBE =\angle DEB = x$. Dari sini didapat $\angle BEC = 180^\circ - \angle BED = \angle DBE + \angle DEB = 2x.$ Lalu dari soal bisa kita misalkan $\angle ABD = \angle CBE = y$ yang berarti  $2y+x=\angle ABD + \angle CBE + \angle DBE = \angle ABC$ dan $\angle BCD = 180^\circ - \angle BEC - \angle CBE = 180^\circ -2x-2y$. 
		
		Karena $AB=AC$ dapat diperoleh $2y+x= \angle ABC=\angle BCD= 180^\circ -2x-2y$ yang menyebabkan $180^\circ = 3y + 3x \implies \angle DBC = x+ y=60^\circ.$ 
		
		Terakhir, karena $O$ adalah titik bagi, maka $\angle COD = 180^\circ - \angle OCD - \angle CDO = 90^\circ + 90^\circ - \frac{1}{2}\angle BCD - \frac{1}{2} CDB = 90^\circ + \frac{1}{2}\angle DBC = 90^\circ + \frac{1}{2}\cdot 60^\circ = 120^\circ.$ \qed
		\end{solusi}
	\end{soalbaru}
...
Jawablah soal-soal berikut dengan menyertakan cara pengerjaan atau argumentasinya.
	...
	\begin{soalbaru} 
		 ...
		 \begin{lemmarev}
		 		 ...
		 		 \begin{buktilemma}
		 		 	Amati bahwa $AB$ adalah diameter lingkaran yang menyebabkan $\angle ACB = 90^\circ$. Karena kita juga punya $\angle DEB=90^\circ$ dari soal, maka $DE \parallel AC$ atau $\angle CDE = \angle DCA$. Padahal karena $ADCB$ siklis kita punya $\angle CAD = \angle DCA$. Sehingga akhirnya kita punya $\angle CDE = \angle CAD \iff \text{DE menyinggung lingkaran (ABCD) di titik D.}$
		 		 \end{buktilemma}
		 ...
		 \begin{lemmarev}
		 		 		$DE$ menyinggung lingkaran luar $\triangle EFB$.
