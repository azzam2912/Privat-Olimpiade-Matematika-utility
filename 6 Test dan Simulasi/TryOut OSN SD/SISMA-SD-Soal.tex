...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.3]{segitigaSamaSisi.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.3]{persegiPanjangDiarsir.png}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.3]{persegiDibelah.png}
\label{fig:enter-label}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.7]{star.png}
    \label{fig:enter-label}
\end{figure}
